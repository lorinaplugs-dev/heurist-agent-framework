...
class TwitterInfoAgent(MeshAgent):
    ...
    def get_system_prompt(self) -> str:
        ...
        # When asked about a profile or tweets:
        # 1. Extract the username or tweet ID
        # 2. Use the right tool:

        # - Profile/tweets → get_user_tweets(username), e.g. "@elonmusk tweets" → username="elonmusk"
        # - Specific tweet → get_twitter_detail(tweet_id), e.g. "Tell me about tweet 123456789"
        # - Search tweets → get_general_search(q), e.g. "Search ethereum tweets" → q="ethereum"
