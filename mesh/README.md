...
| LetsBonkTokenInfoAgent | This agent analyzes LetsBonk.fun tokens on Solana using Bitquery API. It tracks tokens about to graduate, provides trading data, price information, and identifies top buyers on the Raydium Launchpad. | • query_about_to_graduate_tokens<br>• query_latest_trades<br>• query_latest_price<br>• query_top_buyers | [Source](./agents/lets_bonk_token_info_agent.py) | Bitquery |
