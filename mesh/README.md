...
| ArbusAgent | This agent provides cryptocurrency analysis, sentiment tracking, and market intelligence using the Arbus AI API. | • ask_ai_assistant<br>• assistant_summary<br>• report | [Source](./agents/arbus_ai_agent.py) | Arbus |
