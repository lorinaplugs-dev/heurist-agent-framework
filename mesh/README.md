...
| CookieProjectInfoAgent | This agent provides information about crypto projects using Cookie API, including project details, mindshare metrics, and trend analysis. | • get_project_details<br>• search_projects<br>• get_mindshare_graph<br>• get_mindshare_leaderboard | [Source](./agents/cookie_project_info_agent.py) | Cookie API |
