...
| AixbtProjectInfoAgent | This agent can retrieve trending project information using the aixbt API | • search_projects | [Source](./agents/aixbt_project_info_agent.py) | aixbt |
